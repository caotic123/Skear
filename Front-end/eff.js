...
module.exports = {
  ...
  LOGIN : 1,
  SUCESS_LOGIN : 2,
  SEND_TO_FIRST_ACESS : 3,
  LOAD_NAVIGATION : 3,
  NAVIGATE : 4,
  EDIT_LANGS_PROFILE : 5,
  ...
  images : [
    ...
    require ("./assets/screen5.jpg"),
    require ("./assets/screen6.jpg"),
    require ("./assets/screen7.jpg"),
    require ("./assets/screen8.jpg")
  ],
  
  langs : {
  af: { name: 'Afrikaans', native: 'Afrikaans', contries: [ 'NA', 'ZA' ] },
  am: { name: 'Amharic', native: 'አማርኛ', contries: [ 'ET' ] },
  ar: {
    name: 'Arabic',
    native: 'العربية',
    rtl: 1,
  ...
  ay: { name: 'Aymara', native: 'Aymar', contries: [ 'BO' ] },
  az: {
    name: 'Azerbaijani',
    native: 'Azərbaycanca / آذربايجان',
    contries: [ 'AZ' ]
  },
  be: { name: 'Belarusian', native: 'Беларуская', contries: [ 'BY' ] },
  bg: { name: 'Bulgarian', native: 'Български', contries: [ 'BG' ] },
  bi: { name: 'Bislama', native: 'Bislama', contries: [ 'VU' ] },
  bn: { name: 'Bengali', native: 'বাংলা', contries: [ 'BD' ] },
  bs: { name: 'Bosnian', native: 'Bosanski', contries: [ 'BA', 'ME' ] },
  ca: { name: 'Catalan', native: 'Català', contries: [ 'AD', 'ES' ] },
  ch: { name: 'Chamorro', native: 'Chamoru', contries: [ 'GU', 'MP' ] },
  cs: { name: 'Czech', native: 'Česky', contries: [ 'CZ' ] },
  da: { name: 'Danish', native: 'Dansk', contries: [ 'DK' ] },
  de: {
    name: 'German',
    native: 'Deutsch',
    contries: [ 'AT', 'BE', 'CH', 'DE', 'LI', 'LU' ]
  },
  dv: { name: 'Divehi', native: 'ދިވެހިބަސް', rtl: 1, contries: [ 'MV' ] },
  dz: { name: 'Dzongkha', native: 'ཇོང་ཁ', contries: [ 'BT' ] },
  el: { name: 'Greek', native: 'Ελληνικά', contries: [ 'CY', 'GR' ] },
  en: {
    name: 'English',
    native: 'English',
    contries: [
      'AG', 'AI', 'AS', 'AU', 'BB', 'BM', 'BS', 'BW', 'BZ',
      'CA', 'CC', 'CK', 'CM', 'CW', 'CX', 'DM', 'ER', 'FJ',
      'FK', 'FM', 'GB', 'GD', 'GG', 'GH', 'GI', 'GM', 'GS',
      'GU', 'GY', 'HK', 'HM', 'IE', 'IM', 'IN', 'IO', 'JE',
      'JM', 'KE', 'KI', 'KN', 'KY', 'LC', 'LR', 'LS', 'MF',
      'MH', 'MP', 'MS', 'MT', 'MU', 'MW', 'NA', 'NF', 'NG',
      'NR', 'NU', 'NZ', 'PG', 'PH', 'PK', 'PN', 'PR', 'PW',
      'RW', 'SB', 'SC', 'SD', 'SG', 'SH', 'SL', 'SS', 'SX',
      'SZ', 'TC', 'TK', 'TO', 'TT', 'TV', 'TZ', 'UG', 'UM',
      'US', 'VC', 'VG', 'VI', 'VU', 'WS', 'ZA', 'ZM', 'ZW'
    ]
  },
  es: {
    name: 'Spanish',
  ...
  et: { name: 'Estonian', native: 'Eesti', contries: [ 'EE' ] },
  eu: { name: 'Basque', native: 'Euskara', contries: [ 'ES' ] },
  fa: { name: 'Persian', native: 'فارسی', rtl: 1, contries: [ 'IR' ] },
  ff: { name: 'Peul', native: 'Fulfulde', contries: [ 'BF', 'GN' ] },
  fi: { name: 'Finnish', native: 'Suomi', contries: [ 'FI' ] },
  fj: { name: 'Fijian', native: 'Na Vosa Vakaviti', contries: [ 'FJ' ] },
  fo: { name: 'Faroese', native: 'Føroyskt', contries: [ 'FO' ] },
  fr: {
    name: 'French',
    native: 'Français',
    contries: [
  ...
  ga: { name: 'Irish', native: 'Gaeilge', contries: [ 'IE' ] },
  gl: { name: 'Galician', native: 'Galego', contries: [ 'ES' ] },
  gn: { name: 'Guarani', native: "Avañe'ẽ", contries: [ 'AR', 'PY' ] },
  gv: { name: 'Manx', native: 'Gaelg', contries: [ 'IM' ] },
  he: { name: 'Hebrew', native: 'עברית', rtl: 1, contries: [ 'IL' ] },
  hi: { name: 'Hindi', native: 'हिन्दी', contries: [ 'FJ', 'IN' ] },
  hr: {
    name: 'Croatian',
    native: 'Hrvatski',
    contries: [ 'BA', 'HR', 'ME' ]
  },
  ht: { name: 'Haitian', native: 'Krèyol ayisyen', contries: [ 'HT' ] },
  hu: { name: 'Hungarian', native: 'Magyar', contries: [ 'HU' ] },
  hy: { name: 'Armenian', native: 'Հայերեն', contries: [ 'AM', 'CY' ] },
  id: {
    name: 'Indonesian',
    native: 'Bahasa Indonesia',
    contries: [ 'ID' ]
  },
  is: { name: 'Icelandic', native: 'Íslenska', contries: [ 'IS' ] },
  it: {
    name: 'Italian',
    native: 'Italiano',
    contries: [ 'CH', 'IT', 'SM', 'VA' ]
  },
  ja: { name: 'Japanese', native: '日本語', contries: [ 'JP' ] },
  ka: { name: 'Georgian', native: 'ქართული', contries: [ 'GE' ] },
  kg: { name: 'Kongo', native: 'KiKongo', contries: [ 'CD' ] },
  kk: { name: 'Kazakh', native: 'Қазақша', contries: [ 'KZ' ] },
  kl: { name: 'Greenlandic', native: 'Kalaallisut', contries: [ 'GL' ] },
  km: { name: 'Cambodian', native: 'ភាសាខ្មែរ', contries: [ 'KH' ] },
  ko: { name: 'Korean', native: '한국어', contries: [ 'KP', 'KR' ] },
  ku: {
    name: 'Kurdish',
    native: 'Kurdî / كوردی',
    rtl: 1,
  ...
  la: { name: 'Latin', native: 'Latina', contries: [ 'VA' ] },
  lb: {
    name: 'Luxembourgish',
    native: 'Lëtzebuergesch',
    contries: [ 'LU' ]
  },
  ln: { name: 'Lingala', native: 'Lingála', contries: [ 'CD', 'CG' ] },
  lo: { name: 'Laotian', native: 'ລາວ / Pha xa lao', contries: [ 'LA' ] },
  lt: { name: 'Lithuanian', native: 'Lietuvių', contries: [ 'LT' ] },
  lu: { name: 'Luba-Katanga', native: 'Tshiluba', contries: [ 'CD' ] },
  lv: { name: 'Latvian', native: 'Latviešu', contries: [ 'LV' ] },
  mg: { name: 'Malagasy', native: 'Malagasy', contries: [ 'MG' ] },
  mh: {
    name: 'Marshallese',
    native: 'Kajin Majel / Ebon',
    contries: [ 'MH' ]
  },
  mi: { name: 'Maori', native: 'Māori', contries: [ 'NZ' ] },
  mk: { name: 'Macedonian', native: 'Македонски', contries: [ 'MK' ] },
  mn: { name: 'Mongolian', native: 'Монгол', contries: [ 'MN' ] },
  ms: {
    name: 'Malay',
    native: 'Bahasa Melayu',
    contries: [ 'BN', 'MY', 'SG' ]
  },
  mt: { name: 'Maltese', native: 'bil-Malti', contries: [ 'MT' ] },
  my: { name: 'Burmese', native: 'မြန်မာစာ', contries: [ 'MM' ] },
  na: { name: 'Nauruan', native: 'Dorerin Naoero', contries: [ 'NR' ] },
  nb: {
    name: 'Norwegian Bokmål',
    native: 'Norsk bokmål',
    contries: [ 'BV', 'NO' ]
  },
  nd: { name: 'North Ndebele', native: 'Sindebele', contries: [ 'ZW' ] },
  ne: { name: 'Nepali', native: 'नेपाली', contries: [ 'NP' ] },
  nl: {
    name: 'Dutch',
    native: 'Nederlands',
    contries: [
  ...
  nr: { name: 'South Ndebele', native: 'isiNdebele', contries: [ 'ZA' ] },
  ny: { name: 'Chichewa', native: 'Chi-Chewa', contries: [ 'MW' ] },
  oc: { name: 'Occitan', native: 'Occitan', contries: [ 'ES' ] },
  pa: {
    name: 'Panjabi / Punjabi',
    native: 'ਪੰਜਾਬੀ / पंजाबी / پنجابي',
    contries: [ 'AW', 'CW' ]
  },
  pl: { name: 'Polish', native: 'Polski', contries: [ 'PL' ] },
  ps: { name: 'Pashto', native: 'پښتو', rtl: 1, contries: [ 'AF' ] },
  pt: {
    name: 'Portuguese',
    native: 'Português',
    contries: [
  ...
  qu: { name: 'Quechua', native: 'Runa Simi', contries: [ 'BO' ] },
  rn: { name: 'Kirundi', native: 'Kirundi', contries: [ 'BI' ] },
  ro: { name: 'Romanian', native: 'Română', contries: [ 'MD', 'RO' ] },
  ru: {
    name: 'Russian',
    native: 'Русский',
    contries: [
  ...
  rw: { name: 'Rwandi', native: 'Kinyarwandi', contries: [ 'RW' ] },
  sg: { name: 'Sango', native: 'Sängö', contries: [ 'CF' ] },
  si: { name: 'Sinhalese', native: 'සිංහල', contries: [ 'LK' ] },
  sk: { name: 'Slovak', native: 'Slovenčina', contries: [ 'CZ', 'SK' ] },
  sl: { name: 'Slovenian', native: 'Slovenščina', contries: [ 'SI' ] },
  sm: { name: 'Samoan', native: 'Gagana Samoa', contries: [ 'AS', 'WS' ] },
  sn: { name: 'Shona', native: 'chiShona', contries: [ 'ZW' ] },
  so: { name: 'Somalia', native: 'Soomaaliga', contries: [ 'SO' ] },
  sq: { name: 'Albanian', native: 'Shqip', contries: [ 'AL', 'ME', 'XK' ] },
  sr: {
    name: 'Serbian',
    native: 'Српски',
    contries: [ 'BA', 'ME', 'RS', 'XK' ]
  },
  ss: { name: 'Swati', native: 'SiSwati', contries: [ 'SZ', 'ZA' ] },
  st: {
    name: 'Southern Sotho',
    native: 'Sesotho',
    contries: [ 'LS', 'ZA' ]
  ...
  sw: {
    name: 'Swahili',
    native: 'Kiswahili',
    contries: [ 'CD', 'KE', 'TZ', 'UG' ]
  },
  ta: { name: 'Tamil', native: 'தமிழ்', contries: [ 'LK', 'SG' ] },
  tg: { name: 'Tajik', native: 'Тоҷикӣ', contries: [ 'TJ' ] },
  th: { name: 'Thai', native: 'ไทย / Phasa Thai', contries: [ 'TH' ] },
  ti: { name: 'Tigrinya', native: 'ትግርኛ', contries: [ 'ER' ] },
  tk: {
    name: 'Turkmen',
    native: 'Туркмен / تركمن',
    contries: [ 'AF', 'TM' ]
  },
  tn: { name: 'Tswana', native: 'Setswana', contries: [ 'BW', 'ZA' ] },
  to: { name: 'Tonga', native: 'Lea Faka-Tonga', contries: [ 'TO' ] },
  tr: { name: 'Turkish', native: 'Türkçe', contries: [ 'CY', 'TR' ] },
  ts: { name: 'Tsonga', native: 'Xitsonga', contries: [ 'ZA' ] },
  uk: { name: 'Ukrainian', native: 'Українська', contries: [ 'UA' ] },
  ur: { name: 'Urdu', native: 'اردو', rtl: 1, contries: [ 'FJ', 'PK' ] },
  uz: { name: 'Uzbek', native: 'Ўзбек', contries: [ 'AF', 'UZ' ] },
  ve: { name: 'Venda', native: 'Tshivenḓa', contries: [ 'ZA' ] },
  vi: { name: 'Vietnamese', native: 'Tiếng Việt', contries: [ 'VN' ] },
  xh: { name: 'Xhosa', native: 'isiXhosa', contries: [ 'ZA' ] },
  zh: {
    name: 'Chinese',
    native: '中文',
    contries: [ 'CN', 'HK', 'MO', 'SG', 'TW' ]
  },
  zu: { name: 'Zulu', native: 'isiZulu', contries: [ 'ZA' ] }
},
